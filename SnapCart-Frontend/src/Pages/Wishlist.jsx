                ...
                <div className="pt-3 mt-3 border-t border-gray-200 dark:border-gray-700">
                  <div className="flex justify-between items-center">
                    <div className="flex items-center">
                      ...
                      {item.oldPrice && (
                        <span className="ml-2 text-gray-500 line-through text-sm">${item.oldPrice.toFixed(2)}</span>
                      )}
                    </div>
                    {item.discount && (
                      <span className="text-xs font-medium text-green-600 dark:text-green-400">{item.discount}% OFF</span>
                    )}
                  </div>
                </div>
              </div>
