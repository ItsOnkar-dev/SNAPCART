...
const Profile = ({ isOpen, onClose }) => {
  ...
  const handlePasswordUpdate = async () => {
    ...
    if (passwordData.currentPassword === passwordData.newPassword) {
      setPasswordError(
        "New password should not be your current password, please create new one"
      );
      return;
    }
  ...
  const styles = {
    ...
    input:
      "w-full px-4 py-2 rounded-md focus:outline-none bg-gray-200 text-gray-700 dark:bg-slate-600 dark:text-white/80",
    navTab:
      "flex items-center gap-2 px-6 py-4 text-gray-600 hover:text-black dark:text-gray-300 dark:hover:text-white",
  };
        ...
        <div className="flex flex-wrap items-center justify-between gap-10">
          ...
          <div>
            <button
              ...
              className="bg-red-500 hover:bg-red-600 text-white font-semibold rounded-md px-4 py-1.5 flex items-center"
            >
          ...
          {tabs.map((tab) => (
            <button
              ...
              className={`${styles.navTab} ${
                activeTab === tab.id
                  ? "border-b-4 border-cyan-500 text-black dark:text-white"
                  : ""
              }`}
            >
              <tab.icon size={18} />
      ...
      <div className="bg-gray-100 dark:bg-gray-800 rounded-lg shadow-md p-6">
        {activeTab === "profile" && (
          <div>
            ...
            <div className="mt-8">
              <button className="bg-cyan-600 hover:bg-cyan-700 text-white font-semibold rounded-md px-6 py-2">
                Save Changes
              </button>
            </div>
          </div>
            ...
            {userData.orders && userData.orders.length > 0 ? (
              ...
              <div className="flex flex-col items-center justify-center py-12">
                ...
                <button
                  ...
                  className="mt-4 bg-cyan-600 hover:bg-cyan-700 text-white font-semibold rounded-md px-6 py-2"
                >
                  Start Shopping
                </button>
              </div>
                  ...
                  >
                    <div className="flex items-center">
                      <div className="w-12 h-8 bg-gray-200 rounded mr-4 flex items-center justify-center">
                        {method.type === "visa" && (
                          <span className="font-bold text-cyan-800">VISA</span>
                        )}
                        {method.type === "mastercard" && (
                          <span className="font-bold text-red-600">MC</span>
                        )}
                        {method.type === "amex" && (
                          <span className="font-bold text-cyan-500">AMEX</span>
                        )}
                      </div>
                      <div>
            ...
            <div className="space-y-12">
              ...
              <div>
                ...
                <div className="space-y-3">
                  ...
                  <button className="bg-cyan-600 hover:bg-cyan-700 text-white font-semibold rounded-md px-6 py-2 mt-2">
                    Save Preferences
                  </button>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="flex flex-col sm:flex-row items-start gap-6 sm:items-center justify-between py-2">
                  <button
                    className="bg-indigo-500 hover:bg-indigo-600 text-white font-semibold rounded-md px-6 py-2"
                    onClick={downloadUserData}
                  >
                    Download My Data
                  </button>
                  <button
                    className="bg-red-500 hover:bg-red-600 text-white font-semibold rounded-md px-6 py-2"
