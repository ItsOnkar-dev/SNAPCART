        ...
        <AnimatePresence mode='wait'>
          <motion.div key={isLogin ? "login" : "signup"} className={styles.cardContainer} variants={containerVariants} initial='hidden' animate='visible' exit='exit'>
            ...
            <form onSubmit={handleSubmit} className={styles.formContainer}>
              ...
              <AnimatePresence>
                {!isLogin && (
                  <motion.div className={styles.formGroup} initial={{ opacity: 0, height: 0 }} animate={{ opacity: 1, height: "auto" }} exit={{ opacity: 0, height: 0 }} transition={{ duration: 0.3 }}>
              ...
              <AnimatePresence>
                {isLogin && (
                  <motion.div className='flex items-center justify-between' initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -10 }} transition={{ duration: 0.2 }}>
