...
const BecomeSeller = () => {
  ...
  const styles = {
    ...
    iconWrapper: "w-12 h-12 bg-indigo-100 rounded-full flex items-center justify-center mb-4",
    heading: "text-xl font-semibold text-gray-800 dark:text-white/80 mb-2",
    paragraph: "text-gray-600 dark:text-slate-300",
  ...
  const features = [
    ...
    },
    {
      ...
      description: "Our team is here to help you succeed with personalized assistance.",
    },
    {
      bg: "bg-rose-300",
      icon: (
  ...
  const FeatureCard = ({ feature }) => (
    <div className={`${styles.featureCard} ${feature.bg}`}>
      ...
      <div className='container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl'>
        <div className='bg-white dark:bg-slate-900 border dark:border-gray-600 shadow-2xl rounded-lg overflow-hidden'>
          ...
          <div className='bg-white dark:bg-slate-900 px-6 py-12 text-center border-b border-gray-300 dark:border-gray-500'>
            <h1 className='text-4xl font-extrabold dark:text-white mb-3 tracking-tight'>Join Our Marketplace as a Seller</h1>
            <p className='dark:text-indigo-100 text-gray-500 text-lg max-w-2xl mx-auto text-justify'>
              Start your journey as a seller and reach customers worldwide with your unique products. Expand your reach and grow your business by becoming a seller on SnapCart. We offer you a platform to connect with millions of customers eager to discover unique products like yours.
            </p>
          </div>

          <div className='p-6 md:p-12'>
            {/* Introduction Section - Show for all new sellers */}
            ...
            <section className='bg-transparent rounded-xl p-8 shadow-lg border border-gray-300 dark:border-gray-600 max-w-4xl mx-auto'>
              <h2 className='text-3xl font-bold mb-8 text-center text-gray-800 dark:text-white/80'>Start Selling Today</h2>
              <form onSubmit={handleSubmit} className='space-y-6'>
                ...
                <FormInput id='storeName' label='Store Name' placeholder='Your amazing store name' value={formData.storeName} error={errors.storeName} />
