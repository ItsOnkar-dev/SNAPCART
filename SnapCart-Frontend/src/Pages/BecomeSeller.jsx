  ...
  const features = [
    {
      ...
      title: "Wide Audience",
      description:
        "Connect with millions of potential customers searching for products like yours.",
    },
    {
      bg: "bg-indigo-300",
      ...
      title: "Easy Setup",
      description:
        "Get your store up and running quickly with our streamlined onboarding process.",
    },
    {
      bg: "bg-pink-300",
      ...
      description:
        "Get paid quickly and securely with our trusted payment processing.",
    },
    {
      bg: "bg-rose-300",
      ...
      description:
        "Powerful tools to promote your products and increase visibility.",
    },
    {
      bg: "bg-blue-300",
      icon: "M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z",
      ...
      description:
        "Access detailed analytics to optimize your products and boost sales.",
    },
    {
      bg: "bg-purple-300",
      ...
      description:
        "Gain insights from detailed analytics to optimize your sales strategy.",
    },
  ];
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-8">
          ...
          <div className="text-center mb-16">
            ...
            <p className="max-w-lg md:max-w-3xl mx-auto text-base text-gray-500 dark:text-gray-300 sm:text-lg mt-5 md:text-xl">
              Join thousands of successful sellers and turn your passion into
                ...
                <button
                  onClick={
                    isLoggedIn
                      ...
                      : () => {
                          toast.warning(
                            "Please login first to become a seller"
                          );
                          navigate("/registration");
                        }
                  }
          ...
          <section className="mb-20">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              {features.map((feature, index) => (
                <div
                  key={index}
                  className={`p-6 rounded-lg shadow-md hover:shadow-lg transition-all ease-in-out duration-300 transform hover:-translate-y-1 ${feature.bg} bg-opacity-20 dark:bg-opacity-10`}
                >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-16">
              {sellerJourney.map((step, index) => (
                ...
                >
                  ...
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    className="h-6 w-6 text-indigo-600 dark:text-indigo-400 mt-4"
                    fill="none"
                    viewBox="0 0 24 24"
                    stroke="currentColor"
                  >
          ...
          <section className="bg-gradient rounded-lg shadow-xl p-10 text-center text-white">
            ...
            <p className="mb-8 text-indigo-100 max-w-2xl mx-auto">
              Join our marketplace today and reach millions of potential
              customers. It only takes a few minutes to set up your seller
              account.
            </p>
