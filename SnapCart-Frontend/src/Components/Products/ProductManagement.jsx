...
const ProductManagement = () => {
  ...
  return (
    <div className="min-h-screen py-24 bg-gradient-to-br from-white to-blue-50 dark:from-slate-900 dark:to-slate-800 border dark:border-gray-600 shadow-lg rounded-lg">
      <div className="container mx-auto p-6 md:p-8 max-w-7xl">
        {/* Header Section with Logout Button */}
        <div className="mb-12 flex items-center justify-between">
          <div className="">
            <h1 className="text-5xl font-extrabold mb-3 text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-purple-600 dark:from-blue-400 dark:to-purple-400">
              Product Management
            </h1>
            {seller && (
            ...
            <p className="text-gray-600 dark:text-white/70 max-w-2xl mx-auto mt-4">
              Create, update, and manage your product inventory with ease. Add detailed descriptions and
              attractive images to showcase your offerings to potential customers.
            </p>
          </div>
        ...
        <div className="mb-8">
          <h2 className="flex items-center justify-center text-3xl font-bold mb-8 text-center text-black dark:text-white">
            Your Products
            <span className="ml-2 inline-flex items-center justify-center px-2.5 py-1 text-xs font-bold leading-none text-blue-100 bg-blue-500 rounded-full">
          ...
          {Array.isArray(sellerProducts) && sellerProducts.length > 0 ? (
            ...
            <div className="flex flex-col items-center justify-center bg-white dark:bg-slate-800 rounded-xl shadow-md p-12 text-center">
              ...
              <button
                ...
                className="bg-gradient-to-r from-blue-500 to-purple-600 hover:from-blue-600 hover:to-purple-700 text-white font-bold py-3 px-8 rounded-lg shadow-lg hover:shadow-xl focus:outline-none focus:ring-2 focus:ring-blue-400 focus:ring-offset-2 transition-all duration-300 transform hover:-translate-y-1 flex items-center">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="space-y-1">
                ...
                <input
                  ...
                  className="shadow-sm appearance-none border border-gray-300 rounded-lg w-full py-3 px-4 text-gray-700 dark:text-white/80 dark:bg-slate-700 leading-tight focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200"
              ...
              <div className="space-y-1">
                ...
                <input
                  ...
                  onChange={handleInputChange}
                  className="shadow-sm appearance-none border border-gray-300 rounded-lg w-full py-3 px-4 text-gray-700 dark:text-white dark:bg-slate-700 leading-tight focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200"
                  placeholder="0.00"
                  step="0.01"
                  min="0"
                  required
