        ...
        <motion.div
          ...
          <div className='flex flex-col text-center lg:text-start gap-4 w-full relative'>
            ...
            <div className='text-3xl sm:text-4xl font-semibold'>
              ...
              <div className='text-gradient1 dark:text-gradient text-2xl sm:text-3xl lg:text-4xl font-bold'>Your Ultimate Shopping Destination!</div>
              ...
              <h2 className='text-2xl sm:text-3xl mt-6 text-gradient1 dark:text-gradient'>Discover. Shop. Enjoy.</h2>
            </div>
          ...
          <div className='w-full max-w-lg relative'>
            ...
            <div className='relative bg-white/90 dark:bg-slate-800/90 backdrop-blur rounded-2xl shadow-xl px-4 py-12 sm:p-12 sm:mb-10 border border-purple-200 dark:border-purple-800/50 overflow-hidden z-10'>
              ...
              <div className='flex flex-col items-center gap-4 sm:gap-6 mb-6 sm:mb-8 relative'>
                ...
                <p className='text-gray-500 dark:text-gray-300 text-center max-w-xs font-semibold sm:font-normal'>Join thousands of happy shoppers finding amazing deals every day</p>
              </div>
